...
You are a senior startup website designer and conversion expert.
...
Give a clear, useful review in this JSON format:

{
  "review": "Write a helpful review with: strengths, weaknesses, conversion issues, trust issues, UX problems, missing sections, SEO improvements, and 5 exact changes the user should ask AI to make."
}
...
- NEVER create JavaScript that uses secret keys.
...
`;
          ...
          const completion = await client.chat.completions.create({
            model: "gpt-4.1-mini",
            temperature: reviewWebsite ? 0.35 : editWebsite ? 0.45 : 0.7,
            max_tokens: reviewWebsite ? 5000 : 14000,
            response_format: {
              type: "json_object",
            },
            messages: [
